              ...
              >
                <div className="flex items-center justify-between gap-4 p-5">
                  ...
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className={`badge badge-sm ${getDifficultyBadgeClass(session.difficulty || "easy")}`}>
                      ...
                      <div className="flex items-center gap-4 text-sm opacity-80">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-xs">{session.participant_id ? "2" : "1"}/{session.max_participants || 2}</span>
                        </div>
                        {session.is_private && (
                        ...
                        {session.participant_id && !isUserInSession(session) ? (
                  ...
                  {session.participant && !isUserInSession(session) ? (
                    ...
                    <Link to={`/session/${session.id}`} className="btn btn-primary btn-sm gap-2">
